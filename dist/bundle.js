...
var react_select_1 = __webpack_require__(/*! react-select */ "./node_modules/react-select/dist/react-select.esm.js");
var FilterComponent = /** @class */ (function (_super) {
    ...
    FilterComponent.prototype.handleChange = function (selectedValues) {
        var isSelectedAll = selectedValues.find(function (x) { return x.value == 'select_all'; });
        if (selectedValues.length == 0 ||
            isSelectedAll != undefined) {
            this.props.onFilterChange(this.props.data.filter(function (x) { return x.value != 'select_all'; }));
            return;
        }
    ...
    FilterComponent.prototype.render = function () {
        return (React.createElement("div", null,
            ...
            React.createElement(react_select_1.default, { onChange: this.handleChange, options: this.props.data, isMulti: true, closeMenuOnSelect: false })));
    };
...
var HomeComponent = /** @class */ (function (_super) {
    ...
    HomeComponent.prototype.render = function () {
        return (React.createElement(Filter_1.FilterComponent, { label: this.state.label, data: this.state.options, onFilterChange: this.onFilterChange.bind(this) }));
    };
    HomeComponent.prototype.onFilterChange = function (data) {
        console.log(data);
    };
